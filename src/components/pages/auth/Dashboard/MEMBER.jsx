      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-100">
          ...
          <ul className="space-y-4">
            <ActivityItem text="Attendance marked for today" />
            <ActivityItem text="Payslip available for March" />
            <ActivityItem text="Leave request approved" />
            <ActivityItem text="Timesheet submitted" />
          </ul>
        </div>
